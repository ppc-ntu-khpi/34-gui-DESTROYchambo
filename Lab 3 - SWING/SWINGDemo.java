    ...
    private void launchFrame() {
        ...
        report.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                report.append("<b><span style=\"font-size:2em;\">"
                        + "Customers Report </span><br></b>");

                for (int i = 0; i < Bank.getNumberOfCustomers(); i++) {
                    Customer customer = Bank.getCustomer(i);
                    report.append("<b>Customer:</b> ")
                    ...
                    for (int j = 0; j < customer.getNumberOfAccounts(); j++) {
                        ...
                        String accType = (acc instanceof CheckingAccount) ? "Checking Account"
                                : (acc instanceof SavingsAccount) ? "Savings Account" : "Unknown";
                        report.append("<i>" + accType + "</i>:"
                                + " Balance = <span style=\"color:red;\">$")
                                .append(acc.getBalance()).append("</span><br>");
                    }
                    report.append("<hr>");
                }
